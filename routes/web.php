...
Route::post('/feed/a/cari','User\FeedController@search')->name('feed.search');
...
// dashboard guru
Route::get('a/guru','User\GuruController@index')->middleware('auth','role:Guru')->name('guru.index');
//load
Route::post('a/guru','User\LoadController@loadDataAjax')->middleware('auth','role:Guru')->name('guru.loaddata');
Route::post('loadshow','User\LoadController@loadDataAjaxShow')->middleware('auth','role:Guru')->name('guru.loadshow');
Route::post('a/guru/loadcomment','User\LoadController@loadDataComment')->name('guru.loadcomment')->middleware('auth','role:Guru');
Route::post('a/guru/loadcommentshow','User\LoadController@loadDataCommentShow')->name('guru.loadcommentshow')->middleware('auth','role:Guru');
//guru core
Route::post('a/guru/post', 'User\GuruController@addPost')->name('guru.addpost')->middleware('auth','role:Guru');
Route::post('a/guru/status', 'User\GuruController@addStatus')->name('guru.addstatus')->middleware('auth','role:Guru');
Route::delete('a/guru/{id}', 'User\GuruController@deletePost')->name('guru.deletepost')->middleware('auth','role:Guru');
Route::put('a/guru/status/{id}', 'User\GuruController@updateStatus')->name('guru.updatestatus')->middleware('auth','role:Guru');
Route::put('a/guru/post/{id}', 'User\GuruController@updatePost')->name('guru.updatepost')->middleware('auth','role:Guru');
Route::get('a/guru/{id}/edit', 'User\GuruController@editPost')->name('guru.editpost')->middleware('auth','role:Guru');
Route::post('a/guru/comment', 'User\GuruController@addComment')->name('guru.addcomment')->middleware('auth','role:Guru');
Route::delete('a/guru/comment/{id}', 'User\GuruController@deleteComment')->name('guru.deletecomment')->middleware('auth','role:Guru');
Route::get('a/guru/{post}', 'User\GuruController@showPost')->name('guru.show')->middleware('auth','role:Guru');
Route::get('a/guru/{post}/download','User\GuruController@download')->name('guru.download')->middleware('auth','role:Guru');
// agenda
Route::post('a/guru/a/agenda/store', 'User\GuruController@addAgenda')->name('guru.addagenda')->middleware('auth','role:Guru');
Route::post('a/guru/a/agenda/detailstore', 'User\GuruController@AddDetail')->name('guru.AddDetail')->middleware('auth','role:Guru');
Route::get('a/guru/a/agenda/','User\GuruController@indexAgenda')->name('guru.indexagenda')->middleware('auth','role:Guru');
Route::get('a/guru/a/agenda/{id}/show', 'User\GuruController@showAgenda')->name('guru.showagenda')->middleware('auth','role:Guru');
Route::put('a/guru/a/agenda/{id}/update', 'User\GuruController@updateAgenda')->name('guru.updateagenda')->middleware('auth','role:Guru');
Route::put('a/guru/a/agenda/{id}/updateAgendaList', 'User\GuruController@updateAgendaList')->name('guru.updateAgendaList')->middleware('auth','role:Guru');
Route::get('a/guru/a/agenda/{id}/download','User\GuruController@agendaDownload')->name('guru.agendadownload')->middleware('auth','role:Guru');
Route::delete('a/guru/a/agenda/{id}', 'User\GuruController@deleteAgenda')->name('guru.deleteagenda')->middleware('auth','role:Guru');
// notifications
...
// request responder
Route::get('a/guru/a/responder','User\GuruController@indexResponder')->name('guru.indexresponder')->middleware('auth','role:Guru');
Route::get('a/guru/a/responder/{id}/show', 'User\GuruController@showFeed')->name('guru.showresponder')->middleware('auth','role:Guru');
Route::put('a/guru/a/responder/{id}/update', 'User\GuruController@updateFeed')->name('guru.updatefeed')->middleware('auth','role:Guru');
// request pesan konseling
Route::post('a/guru/a/pesan-konseling/{id}/show', 'User\GuruController@showQuestion')->name('guru.showmurid')->middleware('auth','role:Guru');
Route::get('a/guru/a/pesan-konseling','User\GuruController@indexMurid')->name('guru.indexmurid')->middleware('auth','role:Guru');
Route::put('a/guru/a/pesan-konseling/{id}/update','User\GuruController@updatePesan')->name('guru.updatequestion')->middleware('auth','role:Guru');
Route::post('a/guru/a/pesan-konseling/show/{id}','User\LoadController@showQuestion')->name('guru.showquestion')->middleware('auth','role:Guru');
Route::post('a/guru/a/pesan-konseling/post','User\GuruController@addAnswer')->name('guru.addanswer')->middleware('auth','role:Guru');
//profil
Route::put('a/guru/edit/profil/update','User\GuruController@updateProfil')->name('guru.updateprofil')->middleware('auth','role:Guru');
Route::get('a/guru/edit/profil','User\GuruController@editProfil')->name('guru.editprofil')->middleware('auth','role:Guru');
Route::get('a/guru/profil/{user}', 'User\GuruController@showProfil')->name('guru.profil')->middleware('auth','role:Guru');
Route::get('a/guru/profil')->name('guru.profilurl')->middleware('auth','role:Guru');
// filepage and search and sortir
Route::get('a/guru/a/files','User\FileController@filePage')->name('guru.filepage')->middleware('auth','role:Guru');
// Route::get('a/guru/a/files','User\FileController@indexFile')->name('guru.indexFile')->middleware('auth','role:Guru');
Route::get('a/guru/search/people','User\FileController@searchPeople')->name('guru.searchpeople')->middleware('auth','role:Guru');
...
// Route::get('a/guru/a/filesa','User\FileController@searchFile')->name('guru.search')->middleware('auth');
// Route::get('a/guru/a/files','User\FileController@search')->name('guru.s')->middleware('auth');
