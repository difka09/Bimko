...
<head>
	...
	<title>Bimko - 404 Halaman Tidak Ditemukan </title>
...
<div class="stunning-header bg-primary-opacity">
	...
	<div class="stunning-header-content">
		<h1 class="stunning-header-title">404 Halaman Tidak Ditemukan</h1>
		...
		<div class="row">
			<div class="col col-xl-6 m-auto col-lg-6 col-md-12 col-sm-12 col-12">
				<div class="page-404-content">
					...
					<a href="{{Route('guru.index')}}" class="btn btn-primary btn-lg">Kembali Ke Beranda</a>
				</div>
			</div>
		</div>
	</div>
...
<a class="back-to-top" href="#">
	<img src="{{asset('guru/svg-icons/back-to-top.svg')}}" alt="arrow" class="back-icon">
</a>
