                            ...
                            <ul class="notification-list" id="notificationsMenu">
                                ...
                                {{-- <li class="with-comment-photo">
                                    ...
                                    <div class="comment-photo">
                                        <img src="{{asset('guru/img/comment-photo1.jpg')}}" alt="photo">
                                ...
                                {{-- <li>
                                    ...
                                    <div class="notification-event">
                                        ...
                                        <span class="notification-icon">
                                            <svg class="olymp-heart-icon"><use xlink:href="{{asset('guru/svg-icons/sprites/icons.svg#olymp-heart-icon')}}"></use></svg>
                                        </span>
